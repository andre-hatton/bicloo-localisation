...
abstract class ApplicationModel(val mContext: Context) {
    ...
    protected companion object {
         ...
         */
        const val API_KEY: String = "f77445070233c5423ac1d90c604ffa9c860d0416"

        /**
         * L'url de base de l'api
         */
        const val BASE_API_URL: String = "https://api.jcdecaux.com/vls/v1/"

        /**
         * Le contrat utilisé par défaut (pour une futur amélioration)
         */
        const val DEFAULT_CONTRACT_NAME: String = "Nantes"
    }
